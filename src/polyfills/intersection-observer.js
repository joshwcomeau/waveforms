  ...
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : 'object' == typeof exports
        ? (exports.IntersectionObserver = e())
        : (t.IntersectionObserver = e());
})(this, function() {
  return (function(t) {
    function e(n) {
    ...
    function(t, e, r) {
      ...
      var i =
        ...
        d = (function() {
          function t(e, r) {
            if ((o(this, t), !arguments.length))
              throw new TypeError('1 argument required, but only 0 present.');
            var n = new h['default'](e, r, f, this);
            Object.defineProperties(this, {
              root: { value: n.root },
              thresholds: { value: n.thresholds },
              rootMargin: { value: n.rootMargin },
            }),
              p.set(this, n);
          }
          return (
            s(t, null, [
              {
                ...
                set: function(t) {
                  if ('number' != typeof t)
                    throw new TypeError(
                      'type of "idleTimeout" value must be a number.',
                    );
                  if (('undefined' == typeof t ? 'undefined' : i(t)) < 0)
                    throw new TypeError(
                      '"idleTimeout" value must be greater than 0.',
                    );
                  f.idleTimeout = t;
                },
              },
              {
                ...
                set: function(t) {
                  if ('boolean' != typeof t)
                    throw new TypeError(
                      'type of "trackHovers" value must be a boolean.',
                    );
      ...
      ['observe', 'unobserve', 'disconnect', 'takeRecords'].forEach(function(
        t,
      ) {
    ...
    function(t, e) {
      ...
      var i = (function() {
        ...
        s =
          'function' == typeof window.WeakMap &&
    ...
    function(t, e, r) {
      ...
      function i(t) {
        ...
        return function() {
          for (
            var n = this, o = arguments.length, i = Array(o), s = 0;
            s < o;
            s++
          )
            i[s] = arguments[s];
        ...
        h = (function() {
          function t() {
            ...
            o(this, t),
              ...
              (this._isUpdateScheduled = !1),
              (this._repeatCycle = !1),
              (this._hoverInitiated = !1),
              ...
              (this._repeatHandler = i(this.scheduleUpdate, 200)),
              (this._onMouseOver = i(this.startUpdateCycle, 200));
          }
          return (
            (t.prototype.connect = function(t) {
              this.isConnected(t) || this._observers.push(t),
                this._isListening || this._initListeners();
            }),
            (t.prototype.disconnect = function(t) {
              var e = this._observers,
                r = e.indexOf(t);
              ~r && e.splice(r, 1),
                !e.length && this._isListening && this._removeListeners();
            }),
            ...
            (t.prototype._updateObservers = function() {
              for (
                ...
                var i = o;
                i.updateObservations() && (t = !0),
                  i.hasEntries() && i.notifySubscriber();
              }
              return t;
            }),
            (t.prototype.startUpdateCycle = function() {
              (this._cycleStartTime = (0, u['default'])()),
                this.scheduleUpdate();
            }),
            (t.prototype.scheduleUpdate = function(t) {
              ...
              if (e) {
                ...
                if (((this._isUpdateScheduled = !1), !this._wasCycleStarted()))
                  return;
                r
                  ? this.startUpdateCycle()
                  : this._hasIdleTimeEnded()
                    ? this._onCycleEnded()
                    : this.scheduleUpdate();
              } else
                this._isUpdateScheduled ||
                  (l(this.scheduleUpdate), (this._isUpdateScheduled = !0));
            }),
            (t.prototype._hasIdleTimeEnded = function() {
              return (
                (0, u['default'])() - this._cycleStartTime > this._idleTimeout
              );
            }),
            ...
            (t.prototype._onCycleEnded = function() {
              (this._cycleStartTime = -1),
                this._repeatCycle &&
                  ((this._cycleStartTime = 0), this._repeatHandler());
            }),
            (t.prototype._initListeners = function() {
              this._isListening ||
                ((this._isListening = !0),
                window.addEventListener('resize', this.startUpdateCycle, !0),
                window.addEventListener('scroll', this.scheduleUpdate, !0),
                this._trackHovers && this._addHoverListener(),
                c
                  ...
                  : ((this._repeatCycle = !0),
                    window.addEventListener('click', this.startUpdateCycle, !0),
                    this.startUpdateCycle()));
            }),
            (t.prototype._removeListeners = function() {
              this._isListening &&
                ...
                window.removeEventListener('scroll', this.scheduleUpdate, !0),
                this._removeHoverListener(),
                c
                  ? this._mutationsObserver &&
            ...
            (t.prototype.enableHover = function() {
              (this._trackHovers = !0),
                this._isListening && this._addHoverListener();
            }),
            ...
            (t.prototype._addHoverListener = function() {
              this._hoverInitiated ||
                (window.addEventListener('mouseover', this._onMouseOver, !0),
                (this._hoverInitiated = !0));
            }),
            (t.prototype._removeHoverListener = function() {
              this._hoverInitiated &&
                (window.removeEventListener('mouseover', this._onMouseOver, !0),
                (this._hoverInitiated = !1));
            }),
    ...
    function(t, e, r) {
      ...
      function i() {
        var t =
          ...
          e = t;
        return (
          Array.isArray(t) ? t.length || (e = [0]) : (e = [t]),
          e
            .map(function(t) {
              if (((t = Number(t)), !window.isFinite(t)))
        ...
        var e = t.join(' '),
          r = t.map(function(t) {
            var e = /^(-?\d*\.?\d+)(px|%)$/.exec(t) || [],
              ...
              n = e[2],
              o = 'px' === n;
            if (((r = parseFloat(r)), !window.isFinite(r)))
              throw new Error(
                'rootMargin must be specified in pixels or percent.',
              );
            return o || (r /= 100), { value: r, pixels: o };
          });
        ...
        p = (function() {
          function t(e) {
            var r =
              ...
              n = arguments[2],
              a = arguments[3];
            if ((o(this, t), 'function' != typeof e))
              throw new TypeError(
                'The callback provided as parameter 1 is not a function.',
              );
            if ('object' !== ('undefined' == typeof r ? 'undefined' : u(r)))
              throw new TypeError('parameter 2 is not an object.');
            if ('root' in r && !(r.root instanceof Element))
              throw new TypeError('member root is not of type Element.');
            var l = i(r.threshold),
              h = s(r.rootMargin);
            (this.root = r.root || null),
              (this.rootMargin = h.rawData),
              (this.thresholds = Object.freeze(l)),
              (this._root = r.root || document.documentElement),
              (this._callback = e),
              (this._rootMargin = h.parsedData),
              (this._targets = new c.Map()),
              (this._quedEntries = []),
              (this._publicObserver = a || this),
              (this.controller = n);
          }
          return (
            (t.prototype.observe = function(t) {
              ...
              var e = this._targets;
              e.has(t) ||
                (e.set(t, new f['default'](t, this)),
                this.controller.isConnected(this) ||
            ...
            (t.prototype.getThresholdGreaterThan = function(t) {
              for (
                var e = this.thresholds, r = e.length, n = 0;
                n < r && e[n] <= t;
    ...
    function(t, e) {
      ...
      function o(t) {
        return t === document.documentElement
          ? n(0, 0, t.clientWidth, t.clientHeight)
    ...
    function(t, e, r) {
      ...
      function a(t, e, r, n) {
        for (var o = n, i = e.parentNode, a = !1; !a; ) {
          ...
          i === t || 1 !== i.nodeType
            ? ((a = !0), (u = r))
            : 'visible' !== window.getComputedStyle(i).overflow &&
              (u = (0, l.getRectangle)(i)),
            u && (o = s(o, u)),
            (i = i.parentNode);
        }
        return o;
        ...
        d = (function() {
          function t(e, r) {
            o(this, t),
              (this.target = e),
              (this.observer = r),
              (this.prevTargetRect = p),
              (this.prevThreshold = 0),
              (this.prevRatio = 0);
          }
          return (
            (t.prototype.updateIntersection = function(t, e) {
              ...
              if (
                (n.exists &&
                  !(0, l.isEmpty)(r) &&
                  (o = this.observer.getThresholdGreaterThan(n.ratio)),
                (a = o !== this.prevThreshold),
                (this.prevTargetRect = r),
                (this.prevThreshold = o),
                (this.prevRatio = n.ratio),
                n.exists || ((n.ratio = 0), (n.rect = p)),
                a)
              ) {
                var u = new f['default'](
                  this.target,
            ...
            (t.prototype.getIntersectionData = function(t, e, r) {
              var n = this.target;
              r || (r = (0, l.getRectangle)(this.target)),
                e || (e = (0, l.getRectangle)(t));
              var o = i(t, n),
                s = o ? p : a(t, n, e, r),
                u = !o && s.width >= 0 && s.height >= 0,
                c = (0, l.getArea)(s) / (0, l.getArea)(r) || 0;
              return { rect: s, ratio: c, exists: u };
            }),
            t
          );
        })();
    ...
    function(t, e, r) {
      ...
      var o = r(6),
        i = function s(t, e, r, i, a, u) {
          n(this, s),
            Object.defineProperties(this, {
              boundingClientRect: { value: e },
              intersectionRatio: { value: i },
              intersectionRect: { value: (0, o.mapToClientRect)(r) },
              rootBounds: { value: (0, o.mapToClientRect)(a) },
              target: { value: t },
              time: { value: u },
            });
        };
